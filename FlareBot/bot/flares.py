...
AGN = FlarePreprocessing(graceid=args.graceid,
                         path_events_dictionary=args.path_events_dictionary, 
                         path_photometry=args.path_photometry).process_for_flare()

stats = RollingWindowStats(graceid=args.graceid, 
                           agn=AGN,
                           path_events_dictionary=args.path_events_dictionary).get_rolling_window_stats()
