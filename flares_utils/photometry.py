...
parser.add_argument(
    "--action", type=str, required=True, help="Action to perform: all, new, update"
)
...
parser.add_argument(
    ...
    nargs="+",
    required=True,
    help="List of catalog names: quaia, catnorth",
)
parser.add_argument(
    "--saving_photometry",
    type=bool,
    help="True will save completed ZFPS runs to the database",
)
parser.add_argument(
    "--batch_codes", type=list, help="List of batch codes from completed ZFPS runs"
)
parser.add_argument(
